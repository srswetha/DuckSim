...
class DuckSimView(private val duckPond: DuckPond) : JPanel() {
    ...
    val rectangleList = listOf<Rectangle>(
        Rectangle(150, 225, 100, 100), // rectangle for duck 0
        Rectangle(275, 225, 100, 100), // rectangle for duck 1
        Rectangle(400, 225, 100, 100), // rectangle for duck 2
        Rectangle(525, 225, 100, 100), // rectangle for duck 3
        Rectangle(150, 335, 100, 100), // rectangle for duck 4
        Rectangle(275, 335, 100, 100), // rectangle for duck 5
        Rectangle(400, 335, 100, 100), // rectangle for duck 6
        Rectangle(525, 335, 100, 100)  // rectangle for duck 7
    )
    ...
    private fun paintDuck(g: Graphics, duck: Duck, rect: Rectangle) {
        ...
        if (duck.isOnDSWC && duck.state === State.WELCOMING && duck.isFree) {
